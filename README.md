...
This template uses [Eslint](https://eslint.org/) and [TypeScript](https://www.typescriptlang.org/)

Eslint is configured to lint all files including  [Svelte](https://svelte.dev/) files


## Limitation and drawbacks

- Sapper ecosystem evolves rapidly and this template could be out of date quicly. 
- The service worker typings is not really good at the moment and should be heavily improved

As of today this template is *NOT* production ready
## Getting started
### Running the project
